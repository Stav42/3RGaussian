...
class GPFittingNode:
    def __init__(self):
        ...
        self.prediction_pub = rospy.Publisher('gp_predictions3', FloatArray, queue_size=10)
        self.correction_pub = rospy.Publisher('gp_corrections3', FloatArray, queue_size=10)
