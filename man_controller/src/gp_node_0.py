...
class GPFittingNode:
    def __init__(self):
        ...
        self.prediction_pub = rospy.Publisher('gp_predictions1', FloatArray, queue_size=10)
        self.correction_pub = rospy.Publisher('gp_corrections1', FloatArray, queue_size=10)
    ...
    def fit_gp(self, event):
        ...
        print("Calling fitting function 1")
        ...
        with tf.device("/gpu:0"):
            ...
            if len(self.tuning_obs1_buffer) == self.tuning_buffer_size and len(self.tuning_state_buffer) == self.tuning_buffer_size and not self.tuned:
                ...
                # print("Length Scales before GP1 optimization:\n")
