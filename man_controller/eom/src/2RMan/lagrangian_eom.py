...
from Transformation import R01, R12, R23, P01, P12, P23, I1, I2
...
L1, L2 = symbols('L1 L2')
m1, m2, I1xx, I1yy, I1zz, I2xx, I2yy, I2zz  = symbols('m1 m2 I1xx I1yy I1zz I2xx I2yy I2zz')
g = symbols('g')

t = symbols('t')
theta1 = Function('theta1')(t); theta2 = Function('theta2')(t)
theta_d1 = diff(theta1, t); theta_d2 = diff(theta2, t)
theta_dd1 = diff(theta_d1, t); theta_dd2 = diff(theta_d2, t)
...
def sum_of_ke(link1, link2):
    return kinetic_energy(link1) + kinetic_energy(link2)
...
def sum_of_pe(link1, link2):

    T01 = T(R01(theta), P01())
    T12 = T(R12(theta), P12(L1))
    # T23 = T(R23(theta), P23(L2))

    return potential_energy(link1, T01) + potential_energy(link2, T01 * T12)

def main():

    links = obtain_links()
    link1 = links['link1']; link2 = links['link2']
    K = sum_of_ke(link1, link2)
    P = sum_of_pe(link1, link2)
